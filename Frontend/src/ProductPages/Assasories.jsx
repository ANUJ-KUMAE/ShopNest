...
const Assasories = () => {
  ...
  const { loading, error, allAssasories } = useSelector(
    (state) => state.products
  );
  const { filter_Products } = useSelector((state) => state.FilterDetails);

  const [nBHealth, setNBHealth] = useState(allAssasories);
      ...
      <div className="ProductPage-Container">
        ...
        <div className="ProductPage-datas">
          <div className="productPage-leftPart">
            <FilterProduct product={allAssasories} />
          </div>
